...
//
const query1 = "SELECT title,mlength FROM movies WHERE mlength < 100 order by mlength";
//
...
//      Animation   |           968.5
//      Action      |         3853.27
const query3 = "SELECT distinct genre, sum(boxoffice)as total_boxoffice from movies group by genre order by total_boxoffice asc";
//
